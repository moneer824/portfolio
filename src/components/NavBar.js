    ...
    return (
        <nav className='container'>
           ...
           <ul>
               ...
               <li onClick={uncheck}> <i className="far fa-file-alt"></i><a target="_blank" rel='noreferrer' href="https://drive.google.com/file/d/19rR82dAwqaX_mwkFEx6hBAAth_Fex1C8/view?usp=sharing"> Resume </a> </li>
           </ul>
        </nav>
    )
}
